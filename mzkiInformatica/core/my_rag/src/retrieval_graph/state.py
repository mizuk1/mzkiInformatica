...
class State(InputState):
    ...
    cursos_json: list[dict[str, Any]] = field(default_factory=list)
    """List of all retrieved courses in JSON format. Used by generate_recommendations to analyze all courses at once.
    Format: [{'curso_id': int, 'titulo': str, 'app': str, 'nivel': str, 'versao': str, 'carga_horaria': str, 
    'descricao_curta': str, 'objetivos': str, 'publico_alvo': str, 'prerequisitos': str, 'modalidades': list, 
    'modulos': list, 'similarity_score': float}, ...]"""

    curso_results: list[dict[str, Any]] = field(default_factory=list)
    """Final results with courses, their order in the learning path, and AI-generated comments.
    Generated by generate_recommendations after analyzing all courses together."""
